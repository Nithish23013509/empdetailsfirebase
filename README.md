...
## MainActivity.java
```
package com.example.ex1_firebase;
...
public class Emp {
    public String id, name, age, salary;

    public Emp() {}

    public Emp(String id, String name, String age, String salary) {
...
```
## OUTPUT
<img width="1919" height="1013" alt="image" src="https://github.com/user-attachments/assets/3e948c6c-296f-4cb4-bafa-6ef63d8dc341" />

<img width="1905" height="918" alt="image" src="https://github.com/user-attachments/assets/aa945562-ce6e-4f15-96e7-7fe25047378a" />
